...
def t_sim_version_117():
    ...
    check("the version quad is 1.1.14-rc.2.70",
          (major, minor, rev, build) == (1, 1, 14, 70), str((major, minor, rev, build)))
    check("the release identity string is 1.1.14-rc.2",
          vstr is not None and vstr.group(1) == "1.1.14-rc.2", vstr.group(1) if vstr else None)
    ...
    check("the changelog top entry is the 1.1.14-rc.2 fixture pre-release",
