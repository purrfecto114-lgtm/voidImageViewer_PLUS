...
def t_sim_version_117():
    ...
    check("the version quad is 1.1.13.64",
          (major, minor, rev, build) == (1, 1, 13, 64), str((major, minor, rev, build)))
    check("the release identity string is 1.1.13-rc.4",
          vstr is not None and vstr.group(1) == "1.1.13-rc.4", vstr.group(1) if vstr else None)
    ...
    check("the changelog top entry is the 1.1.13-rc.4 high dpi icons round",
          top == "Pre-release: Version 1.1.13-rc.4 (the high dpi icons round)", top)
    ...
    check("the readme candidate line says 1.1.13-rc.4",
          "**1.1.13-rc.4 —" in readme and "(the current release candidate):**" in readme)
