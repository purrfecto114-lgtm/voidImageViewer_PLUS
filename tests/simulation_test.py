...
def t_sim_version_117():
    ...
    check("the version quad is 1.1.12.53",
          (major, minor, rev, build) == (1, 1, 12, 53), str((major, minor, rev, build)))
    check("the release identity string is 1.1.12-rc.11",
          vstr is not None and vstr.group(1) == "1.1.12-rc.11", vstr.group(1) if vstr else None)
    ...
    check("the changelog top entry is the 1.1.12-rc.11 carpet repair round",
          top == "Pre-release: Version 1.1.12-rc.11 (the carpet repair round)", top)
    ...
    check("the readme current line says the 1.1.12 release candidate",
          "**1.1.12-rc.11 —" in readme and "(the current release candidate):**" in readme)
