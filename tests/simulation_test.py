...
def t_sim_version_117():
    ...
    check("the version quad is 1.1.14-rc.1.69",
          (major, minor, rev, build) == (1, 1, 14, 69), str((major, minor, rev, build)))
    check("the release identity string is 1.1.14-rc.1",
          vstr is not None and vstr.group(1) == "1.1.14-rc.1", vstr.group(1) if vstr else None)
    ...
    check("the changelog top entry is the 1.1.14-rc.1 todo closure pre-release",
          top == "Pre-release: Version 1.1.14-rc.1 (the todo closure round)", top)
    ...
    check("the readme candidate slot holds the todo closure round",
