...
def t_sim_version_117():
    ...
    check("the version quad is 1.1.14-rc.8.76",
          (major, minor, rev, build) == (1, 1, 14, 76), str((major, minor, rev, build)))
    check("the release identity string is 1.1.14-rc.8",
          vstr is not None and vstr.group(1) == "1.1.14-rc.8", vstr.group(1) if vstr else None)
