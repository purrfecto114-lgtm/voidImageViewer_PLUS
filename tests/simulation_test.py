...
def t_sim_version_117():
    ...
    check("the version quad is 1.1.12.60",
          (major, minor, rev, build) == (1, 1, 12, 60), str((major, minor, rev, build)))
    ...
    check("the changelog top entry is the 1.1.12 remake stable",
          top == "Stable: Version 1.1.12 (the remake stable)", top)
